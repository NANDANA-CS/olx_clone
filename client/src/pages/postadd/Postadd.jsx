...
const Postadd = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Nav />
      <div className="flex-grow px-4 sm:px-6 md:px-8 py-6">
        <h2 className="text-2xl sm:text-3xl font-bold text-center my-4">POST YOUR AD</h2>
        
        <div className="w-full max-w-4xl mx-auto border shadow-sm">
          <div className="w-full text-lg sm:text-xl flex items-center p-4 sm:pt-6 sm:pr-8 sm:pb-4 sm:pl-8 border-b">
            CHOOSE A CATEGORY
          </div>
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-1/2 border-b md:border-b-0 md:border-r">
              <ul className="w-full">
                <li
                  className="border-b flex items-center text-[#8d9094] hover:text-[#020812] p-3 sm:p-4 fill-[#8d9094] hover:fill-[#020812] cursor-pointer"
                  onClick={() => toggleCategory('Cars')}
                >
                  <svg width="24px" height="24px" viewBox="0 0 1024 1024" data-aut-id="icon" fillRule="evenodd" className="flex-shrink-0">
                    <path
                      className="rui-UJ1uk"
                  ...
                  <p className="flex-grow text-[15px] sm:text-[16px] px-2 sm:px-4">Cars</p>
                  <svg width="20px" height="20px" viewBox="0 0 1024 1024" data-aut-id="icon" fillRule="evenodd" className="flex-shrink-0">
                ...
                >
                  ...
                  <p className="flex-grow text-[15px] sm:text-[16px] px-2 sm:px-4">Bike</p>
                  <svg width="20px" height="20px" viewBox="0 0 1024 1024" data-aut-id="icon" fillRule="evenodd" className="flex-shrink-0">
                    <path className="rui-UJ1uk" d="M277.333 85.333v60.331l366.336 366.336-366.336 366.336v60.331h60.331l409.003-408.981v-35.307l-409.003-409.045z" />
                  </svg>
                </li>
                ...
                >
                  ...
                  <p className="flex-grow text-[15px] sm:text-[16px] px-2 sm:px-4">Electronics & Appliances</p>
                  <svg width="20px" height="20px" viewBox="0 0 1024 1024" data-aut-id="icon" fillRule="evenodd" className="flex-shrink-0">
                    <path className="rui-UJ1uk" d="M277.333 85.333v60.331l366.336 366.336-366.336 366.336v60.331h60.331l409.003-408.981v-35.307l-409.003-409.045z" />
                  </svg>
                </li>
              ...
              {selectedCategory && (
                <ul className="w-full">
                  {subcategories[selectedCategory].map((subcategory, index) => (
                    <li
                      key={index}
                      className="border-b flex items-center text-[#8d9094] p-3 sm:p-4 hover:bg-gray-100 cursor-pointer"
                      onClick={() => handleSubcategoryClick(subcategory)}
                    >
                      <p className="flex-grow text-[15px] sm:text-[16px] px-2 sm:px-4">{subcategory}</p>
                    </li>
                  ))}
                </ul>
              )}
